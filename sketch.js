...
function setup() {
  ...
  for(var i=0; i<boatFrames.length; i++){
    ...
    //get = se tomarán las x,y,w,h del archivo srpiteSheet
...
function draw() {
  ...
  for (var i = 0; i < balls.length; i++){
    ...
    collisionWithBoat(i);
    //[i] posición de x, i posición de y, de las balas de cañon creadas en la linea 86 (function KeyPressed)
  }
...
function showBoats(){
  ...
  if(boats.length > 0){
    ...
    //boats.length = variable individual, que están dentro de la matriz boats
    ...
    // El FOR servira para poner el movimiento. Para
    ...
    if(balls[index] !== undefined && boats[i] !== undefined) {
      ...
      if(collision.collided){
        boats[i].remove(i);
          ...
          //Parentesis cuadrado, remover de la matriz, parentesis normal remover del mundo
